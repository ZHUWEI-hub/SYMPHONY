"""Gym wrappers for HotPotQA and FEVER tasks."""
...
class HistoryWrapper(gym.ObservationWrapper):
    """Wrapper to format observations as history of actions and observations."""
...
class HotPotQAWrapper(gym.Wrapper):
    """Wrapper for HotPotQA dataset with reward computation."""
...
class FeverWrapper(gym.Wrapper):
    """Wrapper for FEVER dataset with reward computation."""
...
class LoggingWrapper(gym.Wrapper):
    """Wrapper for logging trajectories to JSON files."""
