"""Simple baseline strategy for code generation."""
...
SIMPLE_CHAT_INSTRUCTION = (
    "You are a programming assistant. You will be given a function signature and docstring. "
    "You should fill in the following text of the missing function body. For example, the first "
    "line of the completion should have 4 spaces for the indentation so that it fits syntactically "
    "with the preceding signature."
)
...
def run_simple(
    ...
    """Run simple baseline strategy with direct code generation.
    ...
    for i, item in enumerate_resume(dataset, log_path):
        ...
        while cur_pass < pass_at_k:
            ...
            is_passing = exe.evaluate(
                item["entry_point"], cur_func_impl, item["test"], timeout=timeout
            )
            if is_passing:
                is_solved = True
                num_success += 1
